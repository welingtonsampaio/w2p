...
/**
 * Responsável por fazer os tratamentos de cache do W2P,
 * assim como registrar, manipular e limpar o cache. Sendo
 * que todos os caches estarão na pasta de controle dentro
 * da pasta Core.
 *
 * @author Welington Sampaio ( @link http://welington.zaez.net )
 * @version 1.0
...
class Cache
{
    ...
    public function add_cache($name,$type,$content) {
    ...
    private function cache_path() {
        return W2P_INCLUDE +
               ...
               W2p::getInstance()->configuration()->cache_path;
    }
}